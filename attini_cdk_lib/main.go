...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AttiniCdk)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@attini/cdk.AttiniCdkProps",
		reflect.TypeOf((*AttiniCdkProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AttiniDeploymentPlanStack)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_AttiniDeploymentPlanStack{}
	...
	_jsii_.RegisterStruct(
		"@attini/cdk.StackConfigurationProps",
		reflect.TypeOf((*StackConfigurationProps)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@attini/cdk.Startup",
